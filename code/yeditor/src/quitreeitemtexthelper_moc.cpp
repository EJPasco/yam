...
QT_MOC_LITERAL(4, 46, 17)
    ...
    "rsFontName\0onChangedFontName\0"
};
...
void YCQUiTreeItemTextHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onChangedFontName((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (YCQUiTreeItemTextHelper::*_t)(const QString & );
...
// SIGNAL 0
void YCQUiTreeItemTextHelper::onChanged(const QString & _t1)
{
